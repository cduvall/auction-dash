...
import { lookupAuction, addAuction, updateAuction, removeAuction } from "@/features/auctions/api/auctions";
        ...
        <div className="px-5 py-4 max-h-64 overflow-y-auto">
          ...
          {auctions.length === 0 ? (
            ...
            <div className="flex flex-col gap-1.5">
              {auctions.map((a) => (
                <div key={a.id} className={`rounded-md px-3 py-3 transition-colors ${
                  a.id === currentAuctionId ? "bg-ochre/10 border border-ochre/30" : "bg-elevated/40 border border-transparent"
                }`}>
                  {editingId === a.id ? (
                    <div className="flex items-center gap-2">
                      <input
                        className="flex-1 bg-surface border border-elevated text-primary rounded-md px-2 py-1.5 text-sm outline-none focus:border-ochre transition-colors"
                        value={editTitle}
                      ...
                      />
                      <button
                        className="text-olive-light hover:text-olive cursor-pointer transition-colors p-2"
                      ...
                      <button
                        className="text-secondary hover:text-primary cursor-pointer transition-colors p-2"
                    ...
                    <div className="flex items-center gap-2">
                      <button
                        className="flex-1 min-w-0 text-left bg-transparent border-none cursor-pointer p-0 font-sans"
                      ...
                      <button
                        className="text-secondary hover:text-ochre cursor-pointer transition-colors p-2 shrink-0"
                      ...
                      <button
                        className="text-secondary hover:text-terracotta cursor-pointer transition-colors p-2 shrink-0"
